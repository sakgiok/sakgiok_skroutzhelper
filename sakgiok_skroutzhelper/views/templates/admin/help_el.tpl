    ...
    <div class="bootstrap" id="sg_skroutzhelperhelpblock">
        <div class="panel">
            <div class="panel-heading" onclick="$('#sg_skroutzhelper_help_panel').slideToggle();">
                ...
                {if $update.res == 'update'}
                    &nbsp;<span class="sg_skroutzhelper_update_title_success">ΒΡΕΘΗΚΕ ΜΙΑ ΕΝΗΜΕΡΩΣΗ!</span>
                {elseif $update.res == 'current'}
                    &nbsp;<span class="sg_skroutzhelper_update_title_current">ΔΕΝ ΒΡΕΘΗΚΕ ΕΝΗΜΕΡΩΣΗ!</span>
                {elseif $update.res == 'error'}
                    &nbsp;<span class="sg_skroutzhelper_update_title_error">ΣΦΑΛΜΑ ΚΑΤΑ ΤΟΝ ΕΛΕΓΧΟ ΕΝΗΜΕΡΩΣΗΣ!</span>
                {/if}
            </div>
        {/if}
        <div id="sg_skroutzhelper_help_panel"{if $help_ajax == false && $hide == true} style="display: none;"{/if}>
            ...
            <div class="sg_skroutzhelper_help_body">
                <p>Αυτό το πρόσθετο σάς επιτρέπει να δημιουργήσετε το αρχείο xml για το skroutz.gr καθώς και να στέλνετε τα στοιχεία των αγορών σας.</p>
